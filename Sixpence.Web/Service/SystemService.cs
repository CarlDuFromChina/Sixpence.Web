...
namespace Sixpence.Web.Service
{
    public class SystemService
    {
        ...
        public IActionResult GetAvatar(string id)
        {
            ...
            var user = Manager.QueryFirst<UserInfo>(id);
...
";
        ...
        {
            var user = Manager.QueryFirst<UserInfo>("SELECT * FROM user_info WHERE code = @mail OR mailbox = @mail", new Dictionary<string, object>() { { "@mail", code } });
